...
const lang = {
    ...
    basestatus:   vhtml.resultdiv.replace('{&%}',       `Rete: <b>Smart Chain</b></br>
                                                         Token: <b>Anhydrite</b></br>
                                                         Contratto: <b><a href="https://bscscan.com/token/0x578b350455932ac3d0e7ce5d7fa62d7785872221" target="_blank" style="text-decoration: underline;">0x578b350455932ac3d0e7ce5d7fa62d7785872221</a></b></br>
                                                         </br>
                                                         Il tuo indirizzo: <b><a href="https://bscscan.com/address/{&%}" target="_blank" style="text-decoration: underline;">{&%}</a></b></br>
                                                         </br>&nbsp;
                                                         <button class="button" onclick="airdrop('get');">Get Anhydrite</button></br>&nbsp;`),
    nologin:      vhtml.resultdiv.replace('{&%}',       `Rete: <b>Smart Chain</b></br>
                                                         Token: <b>Anhydrite</b></br>
                                                         Contratto: <b><a href="https://bscscan.com/token/0x578b350455932ac3d0e7ce5d7fa62d7785872221" target="_blank" style="text-decoration: underline;">0x578b350455932ac3d0e7ce5d7fa62d7785872221</a></b></br>
                                                         </br>
                                                         </br><b><font color="red">
                                                         Non sei connesso alla blockchain:</font></b></br>&nbsp;</br>&nbsp;
                                                         <button class="button" onclick="airdrop('login');">Connettersi alla blockchain</button></br>&nbsp;`),
    noinstall:    vhtml.resultdiv.replace('{&%}',       `Rete: <b>Smart Chain</b></br>
                                                         Token: <b>Anhydrite</b></br>
                                                         Contratto: <b><a href="https://bscscan.com/token/0x578b350455932ac3d0e7ce5d7fa62d7785872221" target="_blank" style="text-decoration: underline;">0x578b350455932ac3d0e7ce5d7fa62d7785872221</a></b></br>
                                                         </br><b><font color="red">
                                                         Non è instrallato MetaMask:</font></b></br>&nbsp;</br>&nbsp;
                                                         <button class="button" onclick="airdrop('link')">Installare MetaMask</button></br>&nbsp;`),
    metamaskmobile:     vhtml.resultdiv.replace('{&%}', `Rete: <b>Smart Chain</b></br>
                                                         Token: <b>Anhydrite</b></br>
                                                         Contratto: <b><a href="https://bscscan.com/token/0x578b350455932ac3d0e7ce5d7fa62d7785872221" target="_blank" style="text-decoration: underline;">0x578b350455932ac3d0e7ce5d7fa62d7785872221</a></b></br>
                                                         ...
                                                         <li><button class="button" onclick="airdrop('link')">Installare MetaMask</button></br><b><font color="red"></li>
                                                         Se MetaMask è già installato sul tuo dispositivo,è necessario accendere al sito attraverso il browser di MetaMask:</font></b>
                                                         <li><button class="button" onclick="airdrop('link2')">Accendere al browser MetaMask</button></li></br></ul>`),
    update:       vhtml.resultdiv.replace('{&%}',       `Rete: <b>Smart Chain</b></br>
                                                         Token: <b>Anhydrite</b></br>
                                                         Contratto: <b><a href="https://bscscan.com/token/0x578b350455932ac3d0e7ce5d7fa62d7785872221" target="_blank" style="text-decoration: underline;">0x578b350455932ac3d0e7ce5d7fa62d7785872221</a></b></br>
                                                         </br><b><font color="red">
                                                         Se sei già connesso alla blockchain, aggiorna il tuo stato:</font></b></br>&nbsp;</br>&nbsp;
                                                         <button class="button" onclick="airdrop('load');">Aggiorna il tuo stato</button></br>&nbsp;`),
    // *************** Errors *************** //
